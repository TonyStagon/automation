...
import { getTwitterTweetSchema } from "./schema";
import { getTwitterCommentSchema } from "./schema/twitter-schema";
import fs from "fs";
...
export async function runAgent(
    schema: {
        ...
        properties: {
            tweet?: { type: SchemaType.STRING; description: string; maxLength?: number };
            comment?: { type: SchemaType.STRING; description: string };
        };
        required: string[];
    },
    prompt: string
