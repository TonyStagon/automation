...
export const TWITTER_API_CREDENTIALS = {
  consumerKey: process.env.TWITTER_API_KEY || "default_TWITTER_API_KEY",
  consumerSecret: process.env.TWITTER_API_KEY_SECRET || "default_TWITTER_API_SECRET",
  accessToken: process.env.TWITTER_ACCESS_TOKEN || "default_TWITTER_ACCESS_TOKEN",
  accessTokenSecret: process.env.TWITTER_ACCESS_TOKEN_SECRET || "default_TWITTER_ACCESS_SECRET",
